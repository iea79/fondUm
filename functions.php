...
if ( ! function_exists( 'frondendie_setup' ) ) :
	...
	function frondendie_setup() {
		 ...
		 */
		load_theme_textdomain( 'fondUm', get_template_directory() . '/languages' );
...
function frondendie_scripts() {
	...
	wp_enqueue_script( 'frondendie-jQuery', get_template_directory_uri() . '/js/jquery.js', array(), _S_VERSION, true );
...
SCF::add_options_page( 'Слайдер', 'Слайдер', 'manage_options', 'main-slider', 'dashicons-megaphone', 21 );
SCF::add_options_page( 'Настройки сайта', 'Настройки сайта', 'manage_options', 'site-settings', '', 51 );
} );


define( '_SBER_USER', SCF::get_option_meta('site-settings', 'userName_sber') );
define( '_SBER_PASS', SCF::get_option_meta('site-settings', 'password_sber') );
